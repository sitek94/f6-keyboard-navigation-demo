		...
		<>
			...
			<div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
				<div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
					<h2 className="text-xl font-semibold text-gray-800 mb-4">F6 Navigation</h2>
					<p className="text-gray-600 mb-4">
						Use F6 to navigate between main sections (header, sidebar, main content). On this page,
						there's no footer, so F6 will skip it automatically.
					</p>
					<div className="bg-blue-50 p-4 rounded-lg">
						<p className="text-sm text-blue-800">
							<strong>Try it:</strong> Press F6 to cycle through sections, or Shift+F6 to go in
							reverse.
						</p>
					</div>
				</div>
